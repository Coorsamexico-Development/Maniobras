...
<template>
    <AppLayout title="Dashboard">
        <template #header>
            ...
            <ButtonAdd  class="-m-8 mr-10  px-2 py-2" @click="nuevaManiobra"  style="float:right"> <svg viewBox="0 0 20 20" enable-background="new 0 0 20 20" class="inline-block w-6 h-6">
