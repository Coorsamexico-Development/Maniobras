...
const emit = defineEmits(["close", "realoadManiobra"]);
...
const closeModalNewTurno = () => {
    ...
    emit('realoadManiobra', props.maniobra_id);
};
...
<template>
    <DialogModal :show="show" @close="close()">
        <template #title>
            ...
            <ButtonAdd class="px-1 py-1" @click="nuevoTurno" style="float: right">
        ...
        <template #content>
            ...
            <ModalAddTurno :maniobra_id="maniobra_id" :show="openModalNewTurno" @close="closeModalNewTurno" />
