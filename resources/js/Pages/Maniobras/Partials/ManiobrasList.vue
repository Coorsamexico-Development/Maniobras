...
<template>
    <div class="p-2 mt-6 bg-white shadow-md rounded-3xl " :class="message ? 'w-full ' : 'maniobra'">
        <div :class="
            message
        ...
        ">
            ...
            <transition name="slide-fade">
                <div v-if="message">
                    <button @click="$emit('showTurnos', props.maniobra)" type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="26.839" height="20.846"
                            ...
                            <g id="Grupo_7" data-name="Grupo 7" transform="translate(-1098.231 621.986)">
                                <path id="Trazado_16" data-name="Trazado 16"
                                    ...
                                    transform="translate(0 -45.749)" fill="#fff" />
                                <path id="Trazado_17" data-name="Trazado 17"
                                    ...
                                    transform="translate(-43.937 -58.092)" fill="#fff" />
                                ...
                                <path id="Trazado_19" data-name="Trazado 19"
                                    ...
                                    transform="translate(-77.309 -77.385)" fill="#fff" />
                            </g>
                        </svg>
                    </button>
                </div>
            ...
            <transition name="slide-fade">
                <div v-if="message">
                    <button @click="$emit('showCalendar', props.maniobra)" type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25.338" height="20.846"
                            viewBox="0 0 25.338 23.836">
                            <g id="Grupo_10" data-name="Grupo 10" transform="translate(-761.49 396.433)">
                                <path id="Trazado_20" data-name="Trazado 20"
                                    ...
                                    transform="translate(0 -28.935)" fill="#fff" />
                                <path id="Trazado_21" data-name="Trazado 21"
                                    ...
                                    transform="translate(-166.491 -0.011)" fill="#fff" />
                                <path id="Trazado_22" data-name="Trazado 22"
                                    ...
                                    transform="translate(-44.009)" fill="#fff" />
                                <path id="Trazado_23" data-name="Trazado 23"
                                    ...
                                    transform="translate(-158.113 -101.121)" fill="#fff" />
                                <path id="Trazado_24" data-name="Trazado 24"
                                    ...
                                    transform="translate(-96.856 -101.117)" fill="#fff" />
                                <path id="Trazado_25" data-name="Trazado 25"
                                    ...
                                    transform="translate(-34.912 -101.122)" fill="#fff" />
                                <path id="Trazado_26" data-name="Trazado 26"
                                    ...
                                    transform="translate(-158.095 -158.339)" fill="#fff" />
                                <path id="Trazado_27" data-name="Trazado 27"
                                    ...
                                    transform="translate(-96.842 -158.339)" fill="#fff" />
                                <path id="Trazado_28" data-name="Trazado 28"
                                    ...
                                    transform="translate(-34.9 -158.339)" fill="#fff" />
                            </g>
                        </svg>
                    </button>
                </div>
            ...
            <transition name="slide-fade">
                <div v-if="message">
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="25.887" height="20.846"
                            ...
                            <path id="Trazado_41" data-name="Trazado 41"
                                ...
                                transform="translate(-3071.492 585.061)" fill="#fff" />
                        </svg>
                    </button>
                </div>
            </transition>
            ...
            <div class="box">
                <Link :href="'/maniobras?maniobra_id=' + props.maniobra.maniobra_id" preserve-state preserve-scroll
                    :only="['data_grafico_series', 'data_grafico_circulo']">
        ...
        : 'p-1 px-6 my-2 ml-8 mt-0 text-md text-white text-md font-bold bg-green-600 lg:-ml-3  lg:mt-5 rounded-3xl hover:bg-green-500 focus:outline-none focus:shadow-outline'
                ">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        style="enable-background: new 0 0 512 512" xml:space="preserve" fill="currentcolor" height="24"
                        width="24">
